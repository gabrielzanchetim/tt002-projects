...
# Primeiro deve ser resolvido a tarefa da aula 3, onde foi solicitado
# a criação de uma classe Linha e de uma classe Tabela. Após fazer a
# tarefa da aula passada, continuar nesta tarefa.
# Este arquivo (Tarefa.py) não deve ser alterado.
...
print(teste)
# O arquivo carros.txt que possui a tabela vai ser dada para você.
...
# Seu grupo também irá receber um arquivo contendo uma tabela com os candidatos
...
#
# A tabela possui uma coluna chamada 'Partido' (nome da coluna),
# onde cada ítem distinto aparece uma
...
# O próximo método a ser implementado na classe TabelaBD é o método select.
